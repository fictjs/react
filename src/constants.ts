...
export const DATA_FICT_REACT_HOST = 'data-fict-react-host'
export const DATA_FICT_REACT_QRL = 'data-fict-react'
export const DATA_FICT_REACT_PROPS = 'data-fict-react-props'
...
export const DEFAULT_CLIENT_DIRECTIVE: ClientDirective = 'load'
export const DEFAULT_VISIBLE_MARGIN = '200px'
